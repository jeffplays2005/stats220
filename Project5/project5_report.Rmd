...
The main purpose of my visualisation is to identify any trendss based on liquor store proximity vs the school funding amount (in millions NZD) and retention. I was quite curious as my school had quite a lot funding yet had a lot of school leavers before 17 years old. I wanted to see if there was any form of correlation between the funding and liquor store proximity. 

As can be seen from the graph that the most funded school ~9 million had the least amount of liquor stores within a close proximity (~ 1-2), yet had ~150 leavers in total. Following the result, a school with a ~6 million in funding(a fairly average funding) had over 12 liquor stores but had a low leaver rate of about 30-40 students in otal. 
